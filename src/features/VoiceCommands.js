...
export class VoiceCommands {
  ...
  _dispatch(text) {
    const map = [
      ...
      ['open astro|show astro|astro physics|astronomy|space', 'nav:astro'],
      ['solar system', 'topic:solar-system'],
      ['sky map|ar sky', 'topic:ar-sky-map'],
      ['telescope', 'topic:telescope'],
      ['earth moon sun|moon phases', 'topic:earth-moon-sun'],
      ['galaxy|deep space', 'topic:galaxy-deep-space'],
      ['astro missions|space missions', 'topic:astro-missions'],
